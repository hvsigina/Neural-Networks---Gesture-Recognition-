...
new_dimension=old_dimension−filter_size+2∗paddingstride+1
...
(100−21+1,100−21+1,7−21+1) = (99,99,6)
...
There are a few key things to note about the conv-RNN architecture:
    ...
    ansfer learning in the 2D CNN layer rather than training your own CNN 
